...
export default function Contato() {
  ...
  const handleSubmit = (e) => { e.preventDefault(); alert('Mensagem enviada! Entraremos em contato em breve.'); setForm({ name: '', email: '', phone: '', service: '', message: '' }) }
    ...
    <section ref={ref} className="pt-32 pb-24 md:pt-40 md:pb-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-heading text-dark/60 text-lg max-w-2xl mx-auto">Estamos prontos para cuidar do seu sorriso. Preencha o formulário ou entre em contato diretamente.</p>
        </div>
            ...
            <div className="contact-item bg-background border border-dark/10 rounded-[2rem] p-8 shadow-lg">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: Mail, title: 'E-mail', text: 'contato@lineadental.com.br' },
