      ...
      {mobileOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-background/95 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-dark/10 md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <a href="https://pay.cakto.com.br/9fuib6v_992374" target="_blank" rel="noopener noreferrer" className="btn-magnetic bg-accent text-primary px-5 py-3 rounded-full text-sm font-semibold text-center">Quiero Acceder</a>
          </div>
        </div>
      )}
    </nav>
